from typing import Dict, Set, Literal, Tuple, List, Any


class IOCConfig:
    """
    Configuration class for IOC extraction settings
    """
    ...
    def get_empty_ioc_dict(cls) -> Dict[str, Set[str]]:
        ...
        return {category: set() for category in cls.IOC_CATEGORIES}

    @classmethod
    def get_mapped_category(cls, ioc_type: str) -> str:
        """
        ...
        return cls.TYPE_MAPPING.get(ioc_type, ioc_type)
